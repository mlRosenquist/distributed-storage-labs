...
if is_raspberry_pi():
    ...
    server_address = input("Server address: 192.168.68.___ ")
    pull_address = "tcp://192.168.68."+server_address+":5557"
    push_address = "tcp://192.168.68."+server_address+":5558"
    subscriber_address = "tcp://192.168.68."+server_address+":5559"
else:
